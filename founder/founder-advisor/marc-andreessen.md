...
1. Diagnose PMF status bluntly. Pre-PMF, PMF, or post-PMF. No in-between.
   Cite the specific evidence.
2. If pre-PMF, identify the ONE product change most likely to produce pull
   from the market. Not five things — the one.
3. Name the platform wave they're riding (if any) and whether they're
